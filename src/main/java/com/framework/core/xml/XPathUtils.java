...
import static com.framework.core.xml.DOMUtils.text;
...
public final class XPathUtils {
    public static Element selectElement(Node root, String xpath) {
        try {
            ...
            if (!(node instanceof Element))
                throw new XMLException("target node is not element, xpath=" + xpath + ", element=" + text(root));
            return (Element) node;
    ...
    public static String selectText(Node root, String xpath) {
        try {
            ...
            throw new XMLException("unsupported type, xpath=" + xpath + ", element=" + text(root));
        } catch (TransformerException e) {
            throw new XMLException(e);
        }
    }
