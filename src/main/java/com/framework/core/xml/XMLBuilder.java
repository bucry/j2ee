...
public final class XMLBuilder {
    ...
    private void indentForStartElement() throws XMLStreamException {
        if (indented && (Node.START_ELEMENT.equals(lastNode)
                || Node.END_ELEMENT.equals(lastNode))) {
            indent();
        }
    }
    ...
    public XMLBuilder endElement() {
        try {
            if (indented) {
                level--;
                if (Node.END_ELEMENT.equals(lastNode)) indent();
            }
    ...
    public XMLBuilder cdata(String data) {
        ...
        try {
            ...
            if (indented) lastNode = Node.TEXT;
            return this;
        } catch (XMLStreamException e) {
            throw new XMLException(e);
        }
