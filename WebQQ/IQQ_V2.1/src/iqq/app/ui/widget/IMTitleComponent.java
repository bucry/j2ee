...
public class IMTitleComponent extends BackgroundPanel {
	...
	public WebButton getMinBtn() {
		return minBtn;
	}

	public void setMinBtn(WebButton minBtn) {
		this.minBtn = minBtn;
	}

	public WebButton getMaxBtn() {
		return maxBtn;
	}

	public void setMaxBtn(WebButton maxBtn) {
		this.maxBtn = maxBtn;
	}

	public WebButton getCloseBtn() {
		return closeBtn;
	}

	public void setCloseBtn(WebButton closeBtn) {
